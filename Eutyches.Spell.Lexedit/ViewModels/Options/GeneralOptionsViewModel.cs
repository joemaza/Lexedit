...
{
    public class GeneralOptionsViewModel : OptionViewModelBase<GeneralOptions>
    {
        #region Constructors

        protected GeneralOptionsViewModel(IEventAggregator eventAggregator, IFileService fileService, IDialogService dialogService, IToolService toolService)
