...
{
    public class SuggestionOptionsViewModel : OptionViewModelBase<SuggestionOptions>
    {
        #region Constructors

        protected SuggestionOptionsViewModel(IEventAggregator eventAggregator, IFileService fileService, IDialogService dialogService, IToolService toolService)
